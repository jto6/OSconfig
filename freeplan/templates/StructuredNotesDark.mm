...
<stylenode LOCALIZED_TEXT="default" ID="ID_671184412" ICON_SIZE="12 pt" FORMAT_AS_HYPERLINK="false" COLOR="#e5e9f0" BACKGROUND_COLOR="#2e3440" BACKGROUND_ALPHA="0" STYLE="bubble" SHAPE_HORIZONTAL_MARGIN="8 pt" SHAPE_VERTICAL_MARGIN="5 pt" NUMBERED="false" FORMAT="STANDARD_FORMAT" TEXT_ALIGN="DEFAULT" BORDER_WIDTH_LIKE_EDGE="false" BORDER_WIDTH="2 px" BORDER_COLOR_LIKE_EDGE="true" BORDER_COLOR="#f0f0f0" BORDER_DASH_LIKE_EDGE="true" BORDER_DASH="SOLID" MAX_WIDTH="10 cm" MIN_WIDTH="0 cm" VGAP_QUANTITY="2 pt" CHILD_NODES_ALIGNMENT="BY_CENTER" CHILD_NODES_LAYOUT="AUTO" COMMON_HGAP_QUANTITY="14 pt">
...
<stylenode TEXT="subheading" COLOR="#e5e9f0" BACKGROUND_COLOR="#faf3d9" BACKGROUND_ALPHA="0">
