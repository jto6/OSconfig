...
<font SIZE="24"/>
<stylenode LOCALIZED_TEXT="styles.predefined" STYLE="bubble" POSITION="right">
<stylenode LOCALIZED_TEXT="default" ID="ID_671184412" ICON_SIZE="12 pt" FORMAT_AS_HYPERLINK="false" COLOR="#e5e9f0" BACKGROUND_COLOR="#2e3440" BACKGROUND_ALPHA="0" STYLE="fork" SHAPE_HORIZONTAL_MARGIN="8 pt" SHAPE_VERTICAL_MARGIN="5 pt" NUMBERED="false" FORMAT="STANDARD_FORMAT" TEXT_ALIGN="DEFAULT" BORDER_WIDTH_LIKE_EDGE="false" BORDER_WIDTH="2 px" BORDER_COLOR_LIKE_EDGE="true" BORDER_COLOR="#f0f0f0" BORDER_DASH_LIKE_EDGE="true" BORDER_DASH="SOLID" MAX_WIDTH="10 cm" MIN_WIDTH="0 cm" VGAP_QUANTITY="2 pt" CHILD_NODES_ALIGNMENT="BY_CENTER" CHILD_NODES_LAYOUT="AUTO" COMMON_HGAP_QUANTITY="14 pt">
...
<stylenode LOCALIZED_TEXT="styles.user-defined" STYLE="bubble" POSITION="right">
...
<stylenode TEXT="Content" COLOR="#e5e9f0" BACKGROUND_COLOR="#a3be8c" BACKGROUND_ALPHA="0" BORDER_WIDTH_LIKE_EDGE="false" BORDER_WIDTH="0 px" BORDER_COLOR_LIKE_EDGE="true" BORDER_DASH_LIKE_EDGE="false" BORDER_DASH="SOLID">
<font SIZE="12"/>
</stylenode>
